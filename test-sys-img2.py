...
anoxic1 = ctx["anoxic"](name="ANOXIC_TANK_1")

anoxic2 = ctx["anoxic"](name="ANOXIC_TANK_2")

aerobic1 = ctx["aerobic-process-unit"](name="AEROBIC_TANK_1")
aerobic2 = ctx["aerobic-process-unit"](name="AEROBIC_TANK_2")
aerobic3 = ctx["aerobic-process-unit"](name="AEROBIC_TANK_3")
...
graph.serialize("models/test.ttl", format="turtle")
write_to_file(graph, "models/test.png")
